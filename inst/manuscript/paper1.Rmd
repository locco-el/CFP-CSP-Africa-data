...
The institutional theory has been relied upon to explain the difference between CSR in developed and developing economies. Institutional theory explains "organizational and management practices as a product of social rather than economic pressures" (Suddaby, 2013 p 379). Thus, organizations respond to a combination of institutional pressures and conform to their environment in order to receive legitimacy. 

    THE AFRICAN BUSINESS SETTING

    CSP MEASUREMENT IN AFRICA
...
```{r dependencies, echo=F, warnings=F }
...
coms <- all_data[, grepl("com_", names(all_data))]
...
-Descriptive Analysis
[Table 1: Distribution of CSP related variables]

-Results of PCA Analysis
PCA Components 
[Table 2: PCA Principal Components]
[Table 3: Principal Components under Varimax Rotation]
Eigen Vectors
[Table 4: PCA Component Loadings and Eigen Values]
Scree Plot
[Figure 1: Scree Plot of PCA Components]
Distribution of predicted score
[Figure 2: Histogram]
[Figure 3: Mean CSP Scores by country]
[Figure 4: Trend in mean CSP scores over time]
